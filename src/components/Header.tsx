      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center">
          <Link to="/" className="flex items-center">
            ...
            />
            <img
              src="https://ik.imagekit.io/xprogrammer/images/Freshtech%20Innovations%20Primary%20SVG.svg?updatedAt=1748993558403" // Replace with your second image URL
              alt="Mobile Logo"
              className="md:hidden w-[150px] h-[70px] object-cover bg-transparent mix-blend-multiply ml-4 lg:ml-8 flex justify-center"
            />
            <span className="sr-only">Freshtech Innovations</span> {/* Accessibility */}
          </Link>
        </div>

        {/* Desktop Navigation */}
        <nav className="hidden md:flex space-x-12 lg:space-x-16 items-center mx-auto">
          <Link
            to="/about"
