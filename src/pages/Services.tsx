              ...
              <div key={index} className="grid md:grid-cols-3 gap-8 items-center py-8 border-b border-gray-100">
                ...
                <div className="md:col-span-2 flex flex-col space-y-4">
                  ...
                  <div className="relative flex items-center mb-10">
                    <p className="text-2xl text-gray-900">{service.workWithUs}</p>
                    <div className="flex-grow border-b border-gray-200 mx-4"></div>
                    <button className="h-10 w-10 rounded-full bg-sky-100 flex items-center justify-center">
                  ...
                  <div className="relative flex items-center">
                    <p className="text-2xl text-gray-900">{service.learnFromUs}</p>
                    <div className="flex-grow border-b border-gray-200 mx-4"></div>
                    <button className="h-10 w-10 rounded-full bg-sky-100 flex items-center justify-center">
                      <svg className="w-6 h-6 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 9l-7 7-7-7"></path>
